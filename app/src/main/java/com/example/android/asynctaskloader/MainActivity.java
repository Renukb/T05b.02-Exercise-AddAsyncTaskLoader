...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private void makeGithubSearchQuery() {
        ...
        if(TextUtils.isEmpty(githubQuery)){
            mUrlDisplayTextView.setText("No Search entered, so there is nothing to search");
        ...
        android.support.v4.content.Loader<Object> githubSarchLoader=loaderManager.getLoader(GITHUB_SEARCH_LOADER);
        // TODO (22) Get our Loader by calling getLoader and passing the ID we specified
        if(githubSarchLoader==null){
